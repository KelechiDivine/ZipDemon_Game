...
def story_intro():
    ...
    user_choice = input(">>> ")  # Here is your first choice.
    
    if user_choice in answer_A:
        option_rock()
    
    elif user_choice in answer_B:
        print(""
              "\n"
              "Well, that was quick. "
              ""
